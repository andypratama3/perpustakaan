                ...
                <form action="{{ route('dashboard.buku.update', $buku->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-12 col-md-6 col-lg-4 col-xl-3 mb-3 p-3">
                            <label for="cover" class="d-block" style="cursor: pointer;">
                                <div
                                    ...
                                    <img id="bookCoverPreview" src="{{ asset('storage/image/buku/' . $buku->image) }}" alt=""
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('kode_buku') is-invalid @enderror  " id="kode_buku" name="kode_buku" minlength="1"
                                maxlength="6" aria-describedby="kode_buku" value="{{ old('kode_buku', $buku->kode_buku) }}">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 col-lg-4 mb-3">
                            ...
                            <select class="form-select " aria-label="Select rak" id="rak" name="rak" value="{{ old('rak', $buku->rak) }}">
                                <option selected value="{{ $buku->rak }}">{{ $buku->rak }}</option>
                        ...
                        <div class="col-12 col-md-6 col-lg-4 mb-3">
                            ...
                            <select class="form-select form-control @error('kategoris_id') is-invalid @enderror" aria-label="Select category" id="category" name="kategoris_id"
                                value="{{ old('kategoris_id', $buku->kategoris_id) }}">
                                <option selected value="{{ $buku->kategoris_id }}">{{ $buku->kategori->name }}</option>
                                @foreach ($kategoris as $kategori)
                                <option value="{{ $kategori->id }}" {{ $kategori->id == $buku->kategoris_id ? 'selected' : '' }}>{{ $kategori->name }}</option>
                                @endforeach
                            </select>
                            <div class="invalid-feedback">
                                @error('kategoris_id')
                        ...
                        <div class="col-md-12 col-lg-12 mb-3">
                            ...
                            <textarea name="deskripsi" id="" cols="30" rows="10" class="form-control">{{ old('deskripsi', $buku->deskripsi) }}</textarea>
                        </div>
                    </div>
