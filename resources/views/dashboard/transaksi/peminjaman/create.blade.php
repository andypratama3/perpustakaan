                ...
                <form action="{{ route('dashboard.peminjaman.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <input type="date" name="tgl_pinjam" id="tgl_pinjam" class="form-control mt-2 @error('tgl_pinjam') is-invalid @enderror" value="{{ old('tgl_pinjam') }}">
                            @error('tgl_pinjam')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <select name="tenggat" id="tenggat" class="form-select">
                                <option selected disabled>Pilih Tenggat</option>
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <input type="date" name="tgl_kembali" id="tgl_kembali" class="form-control mt-2 @error('tgl_kembali') is-invalid @enderror" value="{{ old('tgl_kembali') }}">
                            @error('tgl_kembali')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
